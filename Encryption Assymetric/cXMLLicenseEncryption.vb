...
Friend Class cXMLLicenseEncryption
    ...
    Private Sub AssymetricEncryptContent(ByVal fileXMLLicensePath As String)
        ...
        Try
            ...
            AssymetricEncrypt(xmlDoc, "LicenseFile", "Virtu@lControls", rsaKey, "VirtualControls")
    ...
    Private Sub SymetricEncryptContent(ByVal fileXMLLicensePath As String)
        ...
        Try
            ...
            SymetricEncrypt(xmlDoc, "LicenseFile", key)
            xmlDoc.Save(fileXMLLicensePath)
            MessageBox.Show("Docuemnt Encrypted successfully")
        Catch e As Exception
    ...
    Public Function ReadDataFromXML(ByVal TypeOfEncryption As Integer, ByVal XMLLicensePath As String, ByVal ProjectType As Integer) As String()
        ...
        Try
            ...
            Dim MacAddressesDecrypted As XmlNodeList = tempXmlDoc.SelectNodes("/PLicenseFile/Project/ProjectType[@val='" & ProjectType.ToString & "']/Mac")
            ...
            If MacAddressesDecrypted.Count > 0 Then
                ...
                For i = 0 To MacAddressesDecrypted.Count - 1
                    aXmlData(i) = MacAddressesDecrypted.Item(i).InnerText
