...
Friend Class RijndaelSimple
    ...
    Public Sub New()
        passPhrase = "V1rtu@LC0nTr0lS" ' can be any string
    ...
    Public Function BeginStringEncryption(ByVal PlainText As String) As String
        Dim EncryptedText As String = ""
        EncryptedText = Encrypt(PlainText)
        Return EncryptedText
    End Function

    Public Function BeginStringDecryption(ByVal PlainText As String) As String
        Dim DecryptedText As String = ""
        DecryptedText = Decrypt(PlainText)
